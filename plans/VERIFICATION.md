...
| Plan 44 phase 0/early F-01/F-02/F-03/F-07/F-10 | контракты для client groups/debt policy, payment-method independence, package fallback, stop acknowledgement, server-anchored timer и notification boundaries; regression matrix F-01…F-13; positive-balance fallback, Core stop-order, countdown projection, active-client deposit/sale guards | contracts, owner plans и matrix обновлены; targeted backend slice `44 passed`, плюс F-10 session guard slice `39 passed`, Ruff clean; Win Core `38 passed`, включая projection и stop-order tests; frontend `21 passed`, включая DepositPanel и active-client sale guards; proto layout `19 passed` | F-01b/group debt, F-02 Windows visual timer, F-03 full access-gate/restart, F-07 live/headed path и F-10 отдельный channel API/Win self-service ещё требуют evidence |
