...
import type { BackendBalanceOperation, BackendClientAnalytics } from "../../api";
...
export function ClientPanel({ client, api, onClose, onSaved, onDeposit, onBonusDeposit }: { client: Client; api?: GameClubApi; onClose: () => void; onSaved: () => void; onDeposit: () => void; onBonusDeposit: () => void }) {
