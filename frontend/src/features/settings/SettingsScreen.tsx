...
import type { BackendClientGroup, BackendLockdownPolicy, BackendNotificationRule, BackendPaymentMethod, BackendWorkstationGroup } from "../../api";
import { themeLabels } from "../../shared/constants";
import { PanelHeader } from "../../shared/components/PanelHeader";
import type { Workstation } from "../../types";
import { SettingsResourceEditors } from "./SettingsResourceEditors";

export function SettingsView({ api, pcs, groups, paymentMethods, clientGroups = [], notificationRules = [], error, onNewGroup, onEditGroup, onNewPaymentMethod, onEditPaymentMethod, onRefresh }: { api?: GameClubApi; pcs: Workstation[]; groups: BackendWorkstationGroup[]; paymentMethods: BackendPaymentMethod[]; clientGroups?: BackendClientGroup[]; notificationRules?: BackendNotificationRule[]; error?: string | null; onNewGroup?: () => void; onEditGroup?: (group: BackendWorkstationGroup) => void; onNewPaymentMethod?: () => void; onEditPaymentMethod?: (method: BackendPaymentMethod) => void; onRefresh?: () => void }) {
