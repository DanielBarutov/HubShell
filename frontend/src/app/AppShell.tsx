  ...
  return <div className="app-shell">
    ...
    <main className="main-content">
      ...
      <div className="content-wrap">
        ...
        {ui.section === "settings" && <SettingsView api={LIVE_MODE ? api : undefined} pcs={currentPcs} groups={workspace.groups} paymentMethods={workspace.paymentMethods} clientGroups={workspace.clientGroups} notificationRules={workspace.notificationRules} error={workspace.error} onRefresh={refreshAfterMutation} onNewGroup={LIVE_MODE ? () => dispatch(selectGroup(null)) : undefined} onEditGroup={LIVE_MODE ? (group) => dispatch(selectGroup(group)) : undefined} onNewPaymentMethod={LIVE_MODE ? () => dispatch(selectPaymentMethod(null)) : undefined} onEditPaymentMethod={LIVE_MODE ? (method) => dispatch(selectPaymentMethod(method)) : undefined} />}
      </div>
    </main>
    <PanelHost />
  </div>;
