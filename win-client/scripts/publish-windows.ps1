...
$projectPath = Join-Path $clientRoot "win-client\src\GameClub.Client.Windows\GameClub.Client.Windows.csproj"
...
if ($SingleFile) {
    ...
    Write-Host "Это self-contained каталог: EXE поставляется вместе с Avalonia/.NET зависимостями."
}
